...
hero:
  ...
  tagline: 7 阶段循环 · 单/双/四排 · 8 大职业 · 6 把传奇 · 赛季战令。一把就让玩家上瘾,一晚就能让服主开局。
  image:
    src: /logo.svg
    alt: HopliteRoyale
  actions:
...
features:
  ...
  - icon: 🎯
    title: 8 大职业可成长
    details: 矿工、弓手、坦克、忍者、炼金、侦察、樵夫、渔夫。打得越多职业等级越高,被动越强。
  - icon: 🔥
    title: 6 把传奇武器
    details: 龙之刃、岩浆棍、守卫者炮 …… 合成 + 主动技能 + 被动 + 图鉴 + 配方书,全套都有。
  - icon: 🏆
    title: 赛季战令
    details: 双轨奖励、每日/每周任务、击杀特效、胜利舞蹈、武器尾迹,长线驱动玩家回流。
  - icon: 🗺️
    title: 实例地图
    details: 基于 AdvancedSlimePaper 模板克隆,每场比赛独立世界,结束自动卸载,不污染主世界。
---
